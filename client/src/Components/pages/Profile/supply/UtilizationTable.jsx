...
import { UtilizationOfBloodSupply } from "../../../../apiCalls/supplyApi.js";
...
const UtilizationTable = () => {
  ...
  const getBloodSupply = async () => {
    try {
      ...
      const response = await UtilizationOfBloodSupply();
      ...
      <div className='overflow-x-auto'>
        <table className='min-w-full divide-y divide-gray-200 mt-5 text-center'>
          <thead className='bg-gray-50'>
            <tr>
              {/* <th className='px-6 py-3 text-left  text-md  text-text-bg font-semibold  uppercase tracking-wider'>
                Supply Type
              </th> */}

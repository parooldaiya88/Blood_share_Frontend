...
import { GetDisplayedOrganizationsForDonor,GetDisplayedOrganizationsForHospital } from "../../../apiCalls/userApiCalls.js";
  ...
  const getBloodSupply = async () => {
    ...
    let response= null
     ...
     if(userType === "hospital") {
      response = await  GetDisplayedOrganizationsForHospital()
     }else {
      response = await GetDisplayedOrganizationsForDonor()
     }
